...
%tu funcion de computo del coste y del gradiente. 
...
disp([numgrad grad]);
fprintf(['Las dos columnas de arriba deberian ser muy similares.\n' ...
         '(A tu izquierda, el gradiente numerico, a la derecha, el gradiente analitico.)\n\n']);

diff = norm(numgrad-grad)/norm(numgrad+grad);
fprintf(['Si tu implementaci�n es correcta, la diferencia relativa \n' ...
         'deberia ser muy pequeña (menor que 1e-9). \n' ...
